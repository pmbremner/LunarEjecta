...
\end{equation}
from Eq.\ \eqref{eq:speed_asof_distance_angle}. Solving for $x_{j,i}^{\pm}$ in either equation, we obtain
\begin{equation}
...
For a given distance, the domain of $x$ is given by
...
v_i \in
\begin{cases}
\left(1-\sqrt{\frac{1-\sin\left(\frac{D_j}{2r_m}\right)}{2}}, 1\right) \text{  for $D_j < \pi r_m$}\\
