...
%The initial zenith angle $\gamma_{p,ap}$ required to reach an apoapsis at a radial distance $r_s$ is given by
...
\end{equation}
solving for $\tan\left(\frac{D}{2r_m}\right)$ and simplifying,
