...
\begin{equation}
\cos\alpha_i = -\sqrt{1 - \left(\frac{\sin\beta_i}{\sin\beta_{max}}\right)^2}.
\end{equation}

\subsubsection{Effective Crater-to-Asset Distance}
The effective crater-to-asset distance can be derived by starting with using the spherical law of cosines for the angles $\beta_i$ and $\alpha_i$,
\begin{align}
