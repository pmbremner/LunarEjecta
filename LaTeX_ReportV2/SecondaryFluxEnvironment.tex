...
%		\centering
%		% include first image
%		\includegraphics[width=.98\linewidth]{EjectaYield_vs_ImpactorSpeed_vs_Mass_SFA1e-9_4gcc.png}  
...
%		\includegraphics[width=.98\linewidth]{EjectaYield_vs_ImpactorSpeed_vs_Mass_WCB1e-9_4gcc.png}  
%		%\caption{Put your sub-caption here}
...
\end{subfigure}
	...
	\caption{The ejecta yield is shown for SFA (first column) and WCB (second column) as a function of impactor speed $U$ and impactor mass $m_{imp}$ for ejecta fragments masses greater than $1\times 10^{-9}$~g (row 1), $1\times 10^{-6}$~g (row 2), $1\times 10^{-3}$~g (row 3), and $1\times 10^{0}$~g (row 4).}
