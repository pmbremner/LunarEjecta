...
\title{Lunar Impact Ejecta Model and Environment\\A Brief Overview V 0.1}
...
The primary flux of sporadic meteoroids onto the surface of the Moon changes depending on the latitudinal location on the Moon. Because of this effect, we generated ephemeris data for different latitudes on the Moon in 5 degree increments from pole to pole along the meridian. We chose a time frame of 19 years, or a Metonic cycle, which takes into account many different Sun-Earth-Moon geometries in order to provide an average primary flux environment.
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.85]{../LaTeX_Report/Fit-to-MEM_low_dens.PNG}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.85]{../LaTeX_Report/Fit-to-MEM_high_dens.PNG}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Near-Earth Object Environment}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.52]{../NEA_Brown/vmass.png}
