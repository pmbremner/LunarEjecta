...
int main(int argc, char const *argv[])
{
	...
	lunarEjecta_Assembly<MEM_HiDensityIglooAvg,
		...
		21, // double new_ND,     // total number of distance increments
        12, // double new_Nazm,   // total number of azimuth increments
        1737.1E3, // double new_radius, // radius of Moon, units of m
        MN_ll,    // latLon& new_ROI,   // lat-lon location of Region-Of-Interest
