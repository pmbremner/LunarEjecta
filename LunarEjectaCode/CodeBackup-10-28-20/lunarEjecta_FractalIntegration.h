...
public:
	...
	double evalIntegral(double new_x_azm,
		                double new_Dbeta,
		                double new_mu,
...
private:
	...
	double HH_AzmDist(double x);
	double HH_integrand(double x0, double x1, double y0, double y1, double x_beta);
	double H_betaIntegrate
				(double x_zenith, // location of center, x_zenith = 1 - cos(zenith)
		         double y, //  of eval, y = v/v_esc
		         double Dx, // width of eval in x_zenith
		         double Dy); // width of eval in y
